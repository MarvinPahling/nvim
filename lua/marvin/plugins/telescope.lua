return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>ff", buildin.find_files, { desc = "Fuzzy find files in cwd" })
    vim.keymap.set("n", "<leader>gi", buildin.lsp_implementations, { desc = "Go To LSP implemtation" })
    vim.keymap.set("n", "<leader>gd", buildin.lsp_definitions, { desc = "Go To LSP definitions" })
